// ==UserScript==
// @name         Red Mist Minimap
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  Red Mist Minimap
// @author       z̗̬̊̅ ͎͜0̐̚ ͓̫m̟͔ b̷̯̘ͭͦ#2038
// @match        https://pixelzone.io/*
// @match        http://pixelzone.io/*
// @homepage     https://discord.io/RM-Zone
// @updateURL    https://raw.githubusercontent.com/zZz0mb/RedMistMinimap/blob/master/minimap.user.js
// @downloadURL  https://raw.githubusercontent.com/zZz0mb/RedMistMinimap/blob/master/minimap.user.js
// @grant        none
// ==/UserScript==
...
window.baseTepmlateUrl = 'https://raw.githubusercontent.com/zZz0mb/RedMistMinimap/master';
...
window.addEventListener('load', function () {
    ...
    div.innerHTML = '<div id="minimapbg" style="position: absolute; right: 0.6em; bottom: 0.6em; z-index: 2;">' +
        '<div class="posy" id="posyt" style="background-size: 100%; background-image: url(https://i.imgur.com/uhK1jKt.png); color: rgb(255, 255, 255); text-align: center; line-height: 42px; vertical-align: middle; width: auto; height: auto; border-radius: 12px; padding: 10px;">' +
        '<div id="minimap-text" style="display: none;"></div>' +
        '<div id="minimap-config" style="line-height:20px;">' +
        '<span id="hide-map" style="cursor:pointer;color:white">❌' +
        ' | <a href="https://discord.io/rm-zone" target="_blank">Discord</a>' +
        ...
        '</div>' +
        '<div id="minimap-config" style="line-height:20px;"></div>' +
...
function loadTemplates() {
    ...
    if (needed_templates.length == 0) {
        if (zooming_in == false && zooming_out == false) {
            document.getElementById("minimap-box").style.display = "none";
            document.getElementById("minimap-text").style.display = "block";
            document.getElementById("minimap-text").innerHTML = "Sem templates nesta área";
        }
    } else {
        document.getElementById("minimap-box").style.display = "block";
        document.getElementById("minimap-text").style.display = "none";
