...
window.addEventListener('load', function () {
    ...
    div.innerHTML = '<div id="minimapbg" style="position: absolute; right: 0.6em; bottom: 0.6em; z-index: 2;">' +
        '<div class="posy" id="posyt" style="background-size: 100%; background-image: url(hhttps://i.imgur.com/ABLXMgc.png); color: rgb(255, 255, 255); text-align: center; line-height: 42px; vertical-align: middle; width: auto; height: auto; border-radius: 5px; padding: 10px;">' +
